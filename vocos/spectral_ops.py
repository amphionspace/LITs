...
class ISTFT(nn.Module):
    ...
    def forward(self, spec: torch.Tensor) -> torch.Tensor:
        ...
        # Inverse FFT; keep only win_length samples (matches torch.stft when win_length < n_fft)
        ifft = torch.fft.irfft(spec, self.n_fft, dim=1, norm="backward")[:, : self.win_length, :]
