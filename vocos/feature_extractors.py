...
from vocos.mel_ops import HiFiGANMelTransform
...
class HiFiGANMelFeatures(FeatureExtractor):
    """Mel features aligned with HIFIGAN/meldataset.py."""
    ...
    def __init__(
        ...
        super().__init__()
        self.mel_transform = HiFiGANMelTransform(
            sample_rate=sample_rate,
            n_fft=n_fft,
            hop_length=hop_length,
